"""
Core Models for Mahad Group Accounting Suite - FINAL & COMPLETE
Multi-Company • Multi-Currency • Double-Entry • Recruitment ERP
© 2025 Mahad Group — Built for Global Domination
"""
...
class FxRate(models.Model):
    from_currency = models.CharField(max_length=3, choices=[
        ('USD', 'USD'), ('AED', 'AED'), ('QAR', 'QAR'), ('INR', 'INR'),
        ('KES', 'KES'), ('PHP', 'PHP'), ('EUR', 'EUR')
    ])
    to_currency = models.CharField(max_length=3, choices=[
        ('USD', 'USD'), ('AED', 'AED'), ('QAR', 'QAR'), ('INR', 'INR'),
        ('KES', 'KES'), ('PHP', 'PHP'), ('EUR', 'EUR')
    ])
...
class Company(models.Model):
    CURRENCY_CHOICES = [
        ('INR', 'Indian Rupee'), ('KES', 'Kenyan Shilling'), ('AED', 'UAE Dirham'),
        ('QAR', 'Qatari Riyal'), ('PHP', 'Philippine Peso'), ('USD', 'US Dollar'), ('EUR', 'Euro')
    ]
    ...
    country = models.CharField(max_length=2, choices=[
        ('IN', 'India'), ('KE', 'Kenya'), ('AE', 'UAE'), ('QA', 'Qatar'), ('PH', 'Philippines')
    ])
    base_currency = models.CharField(max_length=3, choices=CURRENCY_CHOICES, default='AED')
...
class ChartOfAccounts(models.Model):
    ...
    wip_account = models.CharField(max_length=100, default="1200 - Work in Progress")
    accounts_receivable = models.CharField(max_length=100, default="1100 - Accounts Receivable")
    accounts_payable = models.CharField(max_length=100, default="2100 - Accounts Payable")
    tax_payable = models.CharField(max_length=100, default="2200 - VAT/GST Payable")
    revenue_account = models.CharField(max_length=100, default="4000 - Placement Revenue")
    cogs_account = models.CharField(max_length=100, default="5000 - Cost of Services")
    fx_gain = models.CharField(max_length=100, default="8100 - Foreign Exchange Gain")
    fx_loss = models.CharField(max_length=100, default="9100 - Foreign Exchange Loss")
...
class EmployerContract(models.Model):
    RENEWAL_CHOICES = [('MANUAL', 'Manual'), ('AUTO', 'Auto-Renew'), ('NONE', 'Do Not Renew')]
    ...
    renewal_option = models.CharField(max_length=10, choices=RENEWAL_CHOICES, default='MANUAL')
    ...
    def __str__(self):
        return f"{self.contract_number} - {self.employer.name}"
...
class Vendor(models.Model):
    VENDOR_TYPE_CHOICES = [
        ('VISA_AGENT', 'Visa Agent'), ('MEDICAL', 'Medical Center'),
        ('AIRLINE', 'Airline'), ('TRAINING', 'Training Center'), ('OTHER', 'Other')
    ]
...
class Candidate(models.Model):
    STAGE_CHOICES = [
        ('SOURCING', 'Sourcing'), ('SCREENING', 'Screening'), ('DOCUMENTATION', 'Documentation'),
        ('VISA', 'Visa Processing'), ('MEDICAL', 'Medical'), ('TICKET', 'Ticket Issued'),
        ('DEPLOYED', 'Deployed'), ('INVOICED', 'Invoiced')
    ]
...
class CandidateCost(models.Model):
    COST_TYPE_CHOICES = [
        ('VISA', 'Visa Fee'), ('MEDICAL', 'Medical Test'), ('TICKET', 'Air Ticket'),
        ('TRAINING', 'Training'), ('DOCUMENTATION', 'Documentation'), ('OTHER', 'Other')
    ]
...
# ============================================================
# ACCOUNTING MODELS (Invoices, Bills, Payments, Journals)
# ============================================================

class Invoice(models.Model):
    STATUS_CHOICES = [('DRAFT', 'Draft'), ('POSTED', 'Posted'), ('SENT', 'Sent'), ('PAID', 'Paid'), ('CANCELLED', 'Cancelled')]
